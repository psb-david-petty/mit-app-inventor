...
In `SecretWord` I also explored how to write scaled text on a `Canvas` &mdash; embodied in the `display` procedure (including a description of [font-size](http://iamvdo.me/en/blog/css-font-metrics-line-height-and-vertical-align#lets-talk-about-font-size-first)).
